      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          if (!pf.initialized()) {
			...
			//cout << "sense_theta" << sense_theta<<endl;
			//cout << "sigma_pos[0]" << sigma_pos[0]<<endl;
			//cout << "sigma_pos[1]" << sigma_pos[1]<<endl;
			//cout << "sigma_pos[2]" << sigma_pos[2]<<endl;
			//cout << "sigma_pos.size" << sizeof(sigma_pos)<<endl;
			//sleep(10);
		  }
		  else {
			...
			//cout << "sigma_pos" << sigma_pos[0]<<endl;
			//sleep(10);
		  ...
		  //cout<<"sigma_landmark"<<sigma_landmark<<endl;
		  //cout<<"noisy_observations"<<noisy_observations<<endl;
		  //cout<<"map"<<map<<endl;
		  //sleep(1000);	
